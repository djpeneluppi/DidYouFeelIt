 ...
 */
package com.udacity.didyoufeelit;
...
//        Event earthquake = com.udacity.didyoufeelit.Utils.fetchEarthquakeData(USGS_REQUEST_URL);
...
//        updateUi(earthquake);
     ...
     */
    private static class EarthquakeAsyncTask extends AsyncTask<String, Void, Event> {
